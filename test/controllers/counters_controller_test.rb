...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post counters_url, params: { counter: { expire: @counter.expire, start: @counter.start, text: @counter.text, user_id: @counter.user_id } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { expire: @counter.expire, start: @counter.start, text: @counter.text, user_id: @counter.user_id } }
